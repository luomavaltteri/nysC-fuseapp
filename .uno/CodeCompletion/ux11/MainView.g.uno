...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public Template(MainView parent, MainView parentInstance): base("dashboard", false)
        {
            __parent = parent;
        ...
        {
            var self = new DashboardPage(__parent.router);
            self.Name = __selector0;
            return self;
        }
        static global::Uno.UX.Selector __selector0 = "dashboard";
    }
    ...
    void InitializeUX()
    {
        ...
        var dashboard = new Template(this, this);
        ...
        temp16.DefaultPath = "dashboard";
        temp16.Templates.Add(dashboard);
